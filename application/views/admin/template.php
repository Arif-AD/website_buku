    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('home') ?>" class="logo">
                ...
                <span class="logo-mini"><b>Baca</b></span>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview <?= ($title == 'Buku' || $title == 'Pengguna' || $title == 'Admin List') ? 'active' : '' ?>">
						<a href="#">
							<i class="fa fa-database"></i>
							<span>Data Lainya</span>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y') ?> <a href="">Arif Destianto</a>.</strong> All rights
            reserved.
        </footer>
    </div>
