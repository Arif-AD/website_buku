...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <button id="addBuku" class="btn btn-warning" data-toggle="modal" data-target="#modal-default"><b class="text-danger">+ Tambah Buku</b></button>
            <a href="<?= base_url('buku/print') ?>"class="btn btn-success"><i class="fa fa-print"></i> Print</a>
